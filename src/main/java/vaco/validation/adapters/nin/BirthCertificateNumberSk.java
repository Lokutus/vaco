...
/**
 * Slovak NIN - the birth certificate number.<br>
 ...
 * @author lokutus
 */
public class BirthCertificateNumberSk extends NationalIdentificationNumber {
     ...
     * @param message
     */
    public BirthCertificateNumberSk(String nin , String message) {
        this.nin = nin;
        ninCountry = NationalIdentificationNumberCountry.SK;
     ...
     * @param nin
     */
    public BirthCertificateNumberSk(String nin) {
        this(nin, "");
    }
